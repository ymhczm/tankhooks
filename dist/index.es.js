...
var useMediaQuery = function (query) {
    ...
    var stata = ref(mediaQuery.matches);
...
var useFullscreen = function (target, options) {
    ...
    var isFullscreen = ref(fullScreenElement);
...
var useDocumentVisibility = function () {
    var documentVisibility = ref(document.hidden);
    var handler = function () {
...
var useInterval = function (fn, delay, options) {
    ...
    var state = isRef(delay) ? delay : ref(delay);
    if (immediate)
        fn();
    var timer = null;
    ...
    run();
    onUnmounted(function () { return clear(); });
};
...
var useQRCode = function (text, options) {
    ...
    var Qrcode = new qrcode(document.createElement('div'), _assign(_assign({ text: isRef(text) ? text.value : text }, otherOptions), { onRenderingEnd: function (qrCodeOptions, dataURL) {
            state.value = dataURL;
...
var useUnmount = function (fn) {
    var unmounted = onScopeDispose !== null && onScopeDispose !== void 0 ? onScopeDispose : onUnmounted;
    unmounted(function () {
        fn();
    });
};
